        ...
        <div className="bg-white/90 backdrop-blur p-8 rounded-3xl shadow-2xl border border-white/20 animate-fade-in relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
               ...
               <div className="md:col-span-2"><label className="block text-xs font-bold text-slate-500 uppercase mb-2 ml-1">Email ID</label><input required type="email" className="w-full border-b-2 border-slate-200 bg-slate-50/50 p-3 rounded-t-lg focus:border-blue-500 outline-none transition" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} /></div>
